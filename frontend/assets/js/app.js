  ...
  document.getElementById('content').innerHTML=
    ...
    '<div class="classroom">'+
      '<aside class="lesson-sidebar">'+
        '<div class="p-3 border-bottom"><div class="fw-bold">'+esc(data.course.title)+'</div><div class="small text-secondary">'+lessons.length+' Lesson</div></div>'+
...
function renderLessonViewer(){
  ...
  document.getElementById('lessonViewer').innerHTML=
    header+completedBanner+videoSection+textSection+quizSection+taskSection;
...
function renderFlowVideoSection(l){
  var html=
    '<div class="border rounded-4 p-4 mb-4">'+
      '<div class="d-flex justify-content-between align-items-center mb-3">'+
        '<h5 class="mb-0"><span class="badge text-bg-primary me-2">1</span><i class="bi bi-play-btn me-2"></i>Video <span class="small text-secondary">(30%)</span></h5>'+
...
function renderFlowQuizSection(l){
  ...
  var html=
    '<div class="border rounded-4 p-4 mb-4">'+
      '<div class="d-flex justify-content-between align-items-center mb-3">'+
        '<h5 class="mb-0"><span class="badge text-bg-primary me-2">3</span><i class="bi bi-patch-question me-2"></i>Quiz <span class="small text-secondary">(maks. 30%)</span></h5>'+
  ...
  if(l.my_quiz_score!==null){
    html+='<div class="alert alert-success py-2">Nilai Quiz terakhir: <strong>'+Number(l.my_quiz_score||0)+'</strong>. Tahap Tugas sudah terbuka.</div>';
  }
...
function renderFlowTaskSection(l){
  ...
  var html=
    '<div class="border rounded-4 p-4 mb-4">'+
      '<div class="d-flex justify-content-between align-items-center mb-3">'+
        '<h5 class="mb-0"><span class="badge text-bg-primary me-2">4</span><i class="bi bi-clipboard-check me-2"></i>Tugas <span class="small text-secondary">(maks. 40%)</span></h5>'+
