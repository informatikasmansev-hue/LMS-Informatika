...
function renderLessonProgressSummary(l){
  ...
  var score=Number(s.total||0);
  var scoreLabel=s.grade_ready?'Nilai Akhir':'Nilai Sementara';

  var videoText=l.has_video
    ? (l.video_completed
        ? '<span class="text-success"><i class="bi bi-check-circle-fill me-1"></i>'+formatLessonPoint(s.video_points)+'/30</span>'
        : '<span class="text-secondary">'+formatLessonPoint(s.video_points)+'/30</span>')
    : '<span class="text-success"><i class="bi bi-check-circle-fill me-1"></i>30/30</span>';

  var textText=l.text_completed
  ...
  var quizText=l.has_quiz
    ? (l.quiz_completed
        ? '<span class="text-success"><i class="bi bi-check-circle-fill me-1"></i>'+formatLessonPoint(s.quiz_points)+'/30</span>'
        : '<span class="text-secondary">'+formatLessonPoint(s.quiz_points)+'/30</span>')
    : '<span class="text-success"><i class="bi bi-check-circle-fill me-1"></i>30/30</span>';

  var taskWaiting=l.has_task && l.task_completed && Number(s.graded_task_count||0)<Number(s.task_count||0);
  var taskText=l.has_task
    ? (taskWaiting
        ? '<span class="text-warning"><i class="bi bi-clock-history me-1"></i>Menunggu nilai · '+formatLessonPoint(s.task_points)+'/40</span>'
        : (l.task_completed
            ? '<span class="text-success"><i class="bi bi-check-circle-fill me-1"></i>'+formatLessonPoint(s.task_points)+'/40</span>'
            : '<span class="text-secondary">'+formatLessonPoint(s.task_points)+'/40</span>'))
    : '<span class="text-success"><i class="bi bi-check-circle-fill me-1"></i>40/40</span>';
...
function renderFlowVideoSection(l){
  var html=
    '<div class="border rounded-4 p-4 mb-4">'+
      '<div class="d-flex justify-content-between align-items-center mb-3">'+
        '<h5 class="mb-0"><span class="badge text-bg-primary me-2">1</span><i class="bi bi-play-btn me-2"></i>Video <span class="small text-secondary">(30%)</span> <span class="badge text-bg-light ms-2">'+formatLessonPoint((l.lesson_score||{}).video_points)+'/30</span></h5>'+
...
function renderFlowQuizSection(l){
  ...
  var html=
    '<div class="border rounded-4 p-4 mb-4">'+
      '<div class="d-flex justify-content-between align-items-center mb-3">'+
        '<h5 class="mb-0"><span class="badge text-bg-primary me-2">3</span><i class="bi bi-patch-question me-2"></i>Quiz <span class="small text-secondary">(maks. 30%)</span> <span class="badge text-bg-light ms-2">'+formatLessonPoint((l.lesson_score||{}).quiz_points)+'/30</span></h5>'+
  ...
  if(l.my_quiz_score!==null){
    html+='<div class="alert alert-success py-2">Nilai Quiz terbaik: <strong>'+Number(((l.lesson_score||{}).quiz_best)||l.my_quiz_score||0)+'</strong> · Bobot: <strong>'+formatLessonPoint((l.lesson_score||{}).quiz_points)+'/30</strong>. Tahap Tugas sudah terbuka.</div>';
  }
...
function renderFlowTaskSection(l){
  ...
  var html=
    '<div class="border rounded-4 p-4 mb-4">'+
      '<div class="d-flex justify-content-between align-items-center mb-3">'+
        '<h5 class="mb-0"><span class="badge text-bg-primary me-2">4</span><i class="bi bi-clipboard-check me-2"></i>Tugas <span class="small text-secondary">(maks. 40%)</span> <span class="badge text-bg-light ms-2">'+formatLessonPoint((l.lesson_score||{}).task_points)+'/40</span></h5>'+
